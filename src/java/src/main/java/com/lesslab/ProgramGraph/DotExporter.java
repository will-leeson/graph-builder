...
/**
 * This is a DotExporter which is \emph{heavily} based on the SootUp implementation
 * I want to be able to break statements up further,
 */
public class DotExporter {
    ...
    for (BasicBlock<?> block : blocks) {
      ...
      for (Stmt stmt : stmts) {
        if(stmt instanceof JAssignStmt){
            sb.append(getStmtString((JAssignStmt)stmt));
        }
  ...
  public static String getStmtString(JAssignStmt stmt){
    String stmtString = "";
